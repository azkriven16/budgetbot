 ...
 *
 * Live Gemini calls — these cost real tokens (~$0.01 per full run).
 * Run manually before deploying a prompt change: pnpm test:ai
 *
...
describe("AI Parser — golden test cases", () => {
  it("expense message: 'spent $45 on groceries'", async () => {
    // TODO: const result = await parseMessage("spent $45 on groceries");
  ...
  it("income message: 'got paid $3000'", async () => {
    // TODO: const result = await parseMessage("got paid $3000");
    // expect(result.intent).toBe("transaction");
  ...
  it("savings contribution: 'added $200 to vacation fund'", async () => {
    // TODO: const result = await parseMessage("added $200 to vacation fund");
  ...
  it("stock buy: 'bought 5 shares of AAPL at $190'", async () => {
    // TODO: const result = await parseMessage("bought 5 shares of AAPL at $190");
  ...
  it("stock sell: 'sold 2 NVDA at $500'", async () => {
    // TODO: const result = await parseMessage("sold 2 NVDA at $500");
    // expect(result.intent).toBe("investment");
  ...
  it("question: \"what's my balance?\"", async () => {
    // TODO: const result = await parseMessage("what's my balance?");
    // expect(result.intent).toBe("question");
  });

  it("garbage input: 'asdf qwerty 12345'", async () => {
    // TODO: const result = await parseMessage("asdf qwerty 12345");
